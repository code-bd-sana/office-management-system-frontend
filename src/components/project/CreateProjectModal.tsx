    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className='flex max-h-[92vh] w-[calc(100vw-2rem)] flex-col gap-0 overflow-hidden p-0 sm:max-w-2xl'>
        ...
        <div className='shrink-0 px-4 pt-4 sm:px-6 sm:pt-5'>
          <h2 className='text-lg font-semibold text-foreground sm:text-xl'>Create New Project</h2>
        ...
        <div className='min-h-0 flex-1 overflow-y-auto px-4 py-4 sm:px-6'>
          {loadingDropdowns ? (
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-1.5'>
                <label className='text-sm font-medium text-foreground'>Project Remarks</label>
                <Textarea
